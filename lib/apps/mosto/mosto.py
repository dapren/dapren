...
def get_momemtum_tickers():
    ...
    dapren_logger.info('Getting momemtum tickers from http://tradingstockalerts.com/PremiumAlerts/Momentum')
...
def get_daily_50d_200d_price(momemtum_tickers):
    momemtum_tickers_daily_50d_200d_price = {}

    for momemtum_ticker in momemtum_tickers:
        dapren_logger.info('Getting price for {momemtum_ticker}'.format(momemtum_ticker=momemtum_ticker))
        ...
        momemtum_tickers_daily_50d_200d_price[momemtum_ticker] = {
            'price_today': price_today,
            'price_50day_moving_avg': price_50day_moving_avg,
            'price_200day_moving_avg': price_200day_moving_avg
        }

    dapren_logger.info('momemtum_tickers_daily_50d_200d_price=' + str(momemtum_tickers_daily_50d_200d_price))
    return momemtum_tickers_daily_50d_200d_price
...
def get_revenue(momemtum_tickers):
    ...
    for ticker in momemtum_tickers:
        time.sleep( 5 )
        dapren_logger.info('Getting revenue for {ticker}'.format(ticker=ticker))
...
if __name__ == '__main__':
    ...
    #momemtum_tickers_daily_50d_200d_price = get_daily_50d_200d_price(momemtum_tickers)
    #momemtum_tickers_revenue = get_revenue(momemtum_tickers)
